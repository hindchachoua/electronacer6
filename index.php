    ...
    <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url(img/electroimage.png);">
            ...
            <div class="w-full px-24 z-10">
                <h1 class="text-5xl font-bold text-left tracking-wide" style="text-decoration: underline;">Welcome Back</h1>
                <p class="text-3xl my-4">One machine can do the work of fifty ordinary men</p>
            </div>
            <div class="bottom-0 absolute p-4 text-center right-0 left-0 flex justify-center space-x-4">
                ...
                <span>
                    <svg fill="#fff" width="24" height="24" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
                </span>
                <span>
            ...
            <div class="w-full py-6 z-20">
                ...
                <p class="text-gray-100">
                    ...
                    <div class="px-4 pb-2 pt-4">
                        <button type="submit" class="uppercase block w-full p-4 text-lg rounded-full bg-indigo-600 hover:bg-indigo-800 focus:outline-none"><a >sign in</a></button>
                        </form>
                    </div>
                    <br>
                    <br>
                    <div class="text-right text-gray-400 hover:underline hover:text-gray-100">
                        <a href="inscription.php">create a new account</a>
                    </div>
